...
- Проверить ответ.
- Для матрицы A и матриц получившегося разложения вычислить
  числа обусловленности (см. задание 1); сравнить.
- Протестировать на разных матрицах: хорошо обусловленных,
  [очень] плохо обусловленных.
""")
